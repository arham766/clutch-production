...
from src.perception.frames import select_best_frames
from src.perception.providers.base import VisionProvider
...
async def identify(
    ...
    *,
    ...
    best = await asyncio.to_thread(select_best_frames, frames, k, 8)
    if not best:
