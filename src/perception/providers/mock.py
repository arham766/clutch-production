...
class MockVisionProvider:
    ...
    def __init__(
        ...
        look_text: str = "I can see the device in frame.",
    ):
        self._response = response
        self._responder = responder
        self._look_text = look_text
        self.calls: list[tuple[list[bytes], list[CatalogEntry]]] = []
        self.look_calls: list[tuple[list[bytes], str]] = []
    ...
    async def look(self, images: list[bytes], question: str) -> str:
        self.look_calls.append((images, question))
        return self._look_text
